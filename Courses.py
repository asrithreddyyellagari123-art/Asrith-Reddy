ds_course = [['Machine Learning Crash Course by Google [Free]', 'https://developers.google.com/machine-learning/crash-course'],
             ...
             ['Data Science Foundations: Foundations by LinkedIn','https://www.linkedin.com/learning/data-science-foundations-fundamentals-5'],
...
web_course = [['Django Documentation','https://docs.djangoproject.com/'],
...
android_course = [['Android Developer Portal','https://developer.android.com/'],
...
uiux_course = [['Google UX Design Professional Certificate','https://www.coursera.org/professional-certificates/google-ux-design'],
               ...
               ['Adobe XD Resources','https://www.adobe.com/products/xd.html'],
               ['Adobe Creative Cloud Guide','https://helpx.adobe.com/support/creative-cloud.html'],
